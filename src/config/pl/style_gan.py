...
class Config:
    ...
    def __init__(self):
        ...
        g_criterions = [
            {'criterion': LSGeneratorCriterion(), 'name': 'train/gen', 'real': 'image', 'fake': 'pred_random'}
        ]
        d_criterions = [
            {'criterion': LSDiscriminatorCriterion(), 'name': 'train/disc', 'real': 'image', 'fake': 'pred_random'}
        ]
