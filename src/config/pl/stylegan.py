...
class Config:
    ...
    def __init__(self):
        ...
        discriminator_optimizer = torch.optim.AdamW(discriminator.parameters(), lr=5e-4, betas=(0.5, 0.99), eps=1e-8)
        ...
        self.trainer = Trainer(accelerator=self.device, max_epochs=30)
