...
class Config:
    ...
    def __init__(self):
        ...
        generator_optimizer = torch.optim.AdamW(generator.parameters(), lr=6e-3, weight_decay=1e-5)
        ...
        criterions = [
            {'criterion': perc, 'name': 'train/perc', 'pred_key': 'pred_random', 'target_key': 'draw_random'},
            {'criterion': l1, 'name': 'train/l1', 'pred_key': 'pred_random', 'target_key': 'draw_random'},
        ]
        ...
        metrics = [
            ...
            {'metric': psnr, 'name': 'val/psnr', 'pred_key': 'pred_random', 'target_key': 'draw_random'},
        ]
